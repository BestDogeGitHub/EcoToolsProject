...
public class CalcoloPedaggio 
{
	...
	private static int determinaClasseVeicolo( Veicolo v ){return 0;} // metodo che dato un veicolo ne determina la classe
	
	private static int determinaTariffa( Veicolo v, Autostrada a){return 0;} // metodo che determina la tariffa unitaria in base alla classe del veicolo, chiamando 
	// 'determinaClasseVeicolo', e il tipo dell'autostrada
	
	public static int CalcolaPrezzo( Veicolo v, Autostrada a, String nomeCaselloPartenza, String nomeCaselloarrivo ){return 0;} // metodo chiamato nel main per determinare il prezzo del
